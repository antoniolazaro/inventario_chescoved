...
import br.com.vortice.chescoved.inventario.estoquearc.business.MovimentacaoEstoqueBusiness;
...
public class RelatorioMovimentacaoEstoqueMenuItem {
	...
	public void buildMenuItem(BorderPane root){
	    final Label label = new Label("ESTOQUE ARC > RELATÓRIO DE MOVIMENTAÇÃO DE ESTOQUE");
