...
import br.com.vortice.chescoved.inventario.materialinterno.business.MovimentacaoEstoqueBusiness;
...
public class RelatorioMovimentacaoEstoqueMenuItem {
	...
	public void buildMenuItem(BorderPane root){
	    final Label label = new Label("ESTOQUE MATERIAL INTERNO > RELATÓRIO DE MOVIMENTAÇÃO DE ESTOQUE");
