...
import br.com.vortice.chescoved.inventario.materialinterno.business.ProdutoBusiness;
...
public class ProdutoMenuItem {
	...
	private TableView<ProdutoModel> createTableView(){
        ...
        reloadTable(table);
        table.getColumns().addAll(codigoCol,nomeCol,localEstoqueCol,quantidadeCol,valorCustoCol,totalCusto);
        return table;
	}
        ...
        addButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
            	try{
            		...
            		ProdutoModel produtoModel = new ProdutoModel(Long.valueOf(codigo.getText()),nome.getText(),localEstoque.getText(),valorCustoBd,null);
	...
	public void buildMenuItem(BorderPane root){
	    final Label label = new Label("ESTOQUE MATERIAL INTERNO > CONSULTA DE PRODUTOS");
        ...
        final Label labelLista = new Label("ESTOQUE MATERIAL INTERNO > LISTA DE PRODUTOS");
        labelLista.setFont(new Font("Arial", 20));        
        VBox blocoTabela = new VBox();
        blocoTabela.getChildren().addAll(labelLista,table);
        
        
        final Label labelEdicao = new Label("ESTOQUE MATERIAL INTERNO > CADASTRO/EDIÇÃO DE PRODUTOS");
