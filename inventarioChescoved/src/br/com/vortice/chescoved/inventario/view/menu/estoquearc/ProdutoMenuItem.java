package br.com.vortice.chescoved.inventario.view.menu.estoquearc;
...
import br.com.vortice.chescoved.inventario.estoquearc.business.ProdutoBusiness;
...
public class ProdutoMenuItem {
	...
	public void buildMenuItem(BorderPane root){
	    final Label label = new Label("ESTOQUE ARC > CONSULTA DE PRODUTOS");
        ...
        final Label labelLista = new Label("ESTOQUE ARC > LISTA DE PRODUTOS");
        labelLista.setFont(new Font("Arial", 20));        
        VBox blocoTabela = new VBox();
        blocoTabela.getChildren().addAll(labelLista,table);
        
        
        final Label labelEdicao = new Label("ESTOQUE ARC > CADASTRO/EDIÇÃO DE PRODUTOS");
