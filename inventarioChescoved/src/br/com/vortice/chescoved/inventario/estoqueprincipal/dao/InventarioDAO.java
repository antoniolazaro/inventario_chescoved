...
public class InventarioDAO extends DAOAb {
	...
	public void insert(InventarioModel inventario) throws Exception{
        ...
        String sql = "insert into inventario(data_inventario) values(?)";
        try {
	...
	public void insert(List<InventarioProdutoModel> produtosInventario) throws Exception{
		Connection connection = getDBConnection();
        PreparedStatement stmt = null;
        String sql = "insert into inventario_produto(inventario_codigo,produto_codigo,quantidade,quantidade_estoque,divergencia,quantidade_final) values(?,?,?,?,?,?)";
        try {
