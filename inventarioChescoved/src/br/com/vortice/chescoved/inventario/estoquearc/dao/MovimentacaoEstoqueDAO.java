...
public class MovimentacaoEstoqueDAO extends DAOAb {
	...
	public void insert(MovimentacaoEstoqueModel movimentacaoEstoque) throws Exception{
        ...
        String sql = "insert into movimentacao_produto_arc(tipo_movimentacao_codigo,produto_codigo,data_movimentacao,quantidade,nota_fiscal,data_recebimento_produto) values(?,?,?,?,?,?)";
        try {
